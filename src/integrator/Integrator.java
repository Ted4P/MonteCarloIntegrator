...
public class Integrator extends JFrame 
{
	...
	private JRadioButton right, left, mid, trap, simp;
	...
	private void buildMainGUI() {
		...
		trap = new JRadioButton("Trapezoid");
		simp = new JRadioButton("Simpson rule", true);		//2 mid 1 trap
	...
	private void calculate() throws Exception
	{
		...
		double sum = buildEstimate(varSet, vals);
